...
\setbeamertemplate{title page}
{
  ...
  \begin{center}
  \footnotesize \bf \insertauthor\quad | \quad\insertshortinstitute\quad | \quad MARVEL Junior Seminar \quad | \quad Lausanne\quad|\quad \insertdate    
  \end{center}
  %  \end{flushright}
  \end{tcolorbox}
  }
...
\begin{frame}{Koopmans functionals: theory}
   \hbox{
      \begin{minipage}{0.5\textwidth}
         The goal: charged excitations with a functional theory
...
\begin{frame}{Koopmans functionals: theory}
   ...
   \begin{align*}
      ...
      {\alpha_i}
      \biggl(&
      E_\mathsf{Hxc} [\rho-\only<9>{\textcolor{red}}{\rho_i}] -E_\mathsf{Hxc}[\rho] \nonumber \\
      & \qquad + f_i \left( E_\mathsf{Hxc}[\rho-\only<9>{\textcolor{red}}{\rho_i}+\only<9>{\textcolor{red}}{n_i}] -E_{\rm Hxc}[\rho-\only<9>{\textcolor{red}}{\rho_i}] \right)
      \biggr)
   \end{align*}
      }
\end{overlayarea}
...
\begin{frame}{Acknowledgements}
   ...
   \begin{center}
      ...
      Recordings of lectures and tutorials can be found on the Materials Cloud YouTube channel
      \vspace{1em}

      Masters projects available (search on \url{sirop.org})
      \vspace{1em}
